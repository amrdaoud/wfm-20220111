...
import { UserChoice, DayOption, AttendanceType, AttendanceApprovalModel } from 'src/app/app-models/day-offs';
...
export class AdminApprovedComponent implements AfterViewInit {
  ...
  @Output() edited = new EventEmitter<AttendanceApprovalModel>();
  @Input() loadingEditItems! :Observable<number[]>;
  ...
  onSubmit() {
    this.edited.emit(this.frm.value);
    this.stopEditing();
  }
